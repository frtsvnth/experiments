      ...
      <div className="result-page" key={sheet}>
        ...
        {sheet === 2 && (
          <article className="sheet sheet-day">
            ...
            {profile.dayWhy.weather && <DayBlock title="Среда дня" text={profile.dayWhy.weather} />}
            <DayBlock title="Свет" text={profile.dayWhy.lunar} />
            {profile.dayWhy.birth && <DayBlock title="Контур даты" text={profile.dayWhy.birth} />}

            <div className="day-window">
              <h3 className="block-subtitle">Окно дня</h3>
              <div className="day-window-grid">
                ...
                <div>
                  <span className="day-window-label">Середина</span>
            ...
            <div className="method">
              ...
              <ul>
                <li>След оцифровывается как последовательность точек: координата, время, нажим.</li>
                <li>
                  По нему считаются длина, число штрихов, средняя и максимальная скорость, разброс скорости,
                  паузы, кривизна, выход за клетку, покрытие плоскости и распределение по четвертям.
                </li>
                <li>
                  Отдельно измеряются симметрия, совпадение с сеткой, зона старта и финиша, баланс начала и
                  конца, число чернил.
                </li>
                <li>
                  Пять внутренних индексов — собранность, открытость контакту, потребность в ясности, темп
                  решений, запас на вечер — выводятся из этих величин по фиксированным правилам.
                </li>
                <li>
                  Интерпретация соединяет три слоя: устойчивый стиль линии, состояние этой минуты и контекст
                  дня.
                </li>
                <li>
                  Контекст дня: день недели, календарные соседства, погода, освещённость луны и контур даты
                  рождения.
                </li>
                <li>
                  Формулировки выбираются детерминированно: один и тот же след в один и тот же день даёт один и
                  тот же текст.
                </li>
                <li>Рисунок и имя обрабатываются в браузере и не передаются на сервер.</li>
              </ul>
            </div>
